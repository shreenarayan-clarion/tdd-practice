...
class QuotationsControllerTest < ActionController::TestCase
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post :create, quotation: { device_request_id: @quotation.device_request_id, identifier: @quotation.identifier, on_date: @quotation.on_date }
    end
  ...
  test "should update quotation" do
    patch :update, id: @quotation, quotation: { device_request_id: @quotation.device_request_id, identifier: @quotation.identifier, on_date: @quotation.on_date }
    assert_redirected_to quotation_path(assigns(:quotation))
  end
