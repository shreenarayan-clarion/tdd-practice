...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { deleted_at: @branch.deleted_at, name: @branch.name, parent_id: @branch.parent_id }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { deleted_at: @branch.deleted_at, name: @branch.name, parent_id: @branch.parent_id }
    assert_redirected_to branch_path(assigns(:branch))
  end
