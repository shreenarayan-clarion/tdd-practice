...
class PurchaseOrdersControllerTest < ActionController::TestCase
  ...
  test "should create purchase_order" do
    assert_difference('PurchaseOrder.count') do
      post :create, purchase_order: { identifier: @purchase_order.identifier, on_date: @purchase_order.on_date, quotation_id: @purchase_order.quotation_id }
    end
  ...
  test "should update purchase_order" do
    patch :update, id: @purchase_order, purchase_order: { identifier: @purchase_order.identifier, on_date: @purchase_order.on_date, quotation_id: @purchase_order.quotation_id }
    assert_redirected_to purchase_order_path(assigns(:purchase_order))
  end
