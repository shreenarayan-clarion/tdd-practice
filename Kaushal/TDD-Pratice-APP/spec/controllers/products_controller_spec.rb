...
RSpec.describe ProductsController, type: :controller do
  ...
  let(:valid_attributes) {
    {name: 'Double Socket', shopify_product_id: "sd4542342", base_price: 323.2, image: Faker::Avatar.image, admin_id: super_admin.id}
  }
  ...
  describe "GET #index" do
    it "assigns all products as @products" do
      ...
      get :index
      expect(assigns(:products).resultset).to eq([product])
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        {name: 'Mobile Socket', shopify_product_id: "es33342", base_price: 322.2, image: Faker::Avatar.image, admin_id: super_admin.id}
      }
